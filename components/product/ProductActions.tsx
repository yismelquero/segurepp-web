...
export function ProductActions({
  ...
  const priceMessage = encodeURIComponent(
    `Hola, quiero consultar el precio del producto: ${nombreProducto}.`
  )
  ...
  return (
    ...
    >
      ...
      {/* CTA 2 — Consultar precio */}
      <a
        href={`https://wa.me/${whatsapp}?text=${priceMessage}`}
        target="_blank"
        rel="noopener noreferrer"
